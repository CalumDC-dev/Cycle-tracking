...
class DatabaseMigrationTests(unittest.TestCase):
    def test_init_db_adds_sync_columns_to_existing_tables(self):
        ...
        profile_columns = self._columns(conn, "calibration_profiles")
        self.assertIn("mechanical_efficiency", profile_columns)
        self.assertIn("pedal_to_flywheel_ratio", profile_columns)
